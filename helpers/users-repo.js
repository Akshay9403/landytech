...
function create({title, firstName, lastName, email, roles, password}) {
  const user = {title, firstName, lastName, email, roles, password};
...
function update(id, {title, firstName, lastName, email, roles, password}) {
  const params = {title, firstName, lastName, email, roles, password};
